...
public:
    ...
    MonitorDataSnapshot m_monitor_data_snapshot{};
...
public:
    ...
    MonitorDataSnapshot GetMonitorDataSnapshot();    //获取监控数据快照
    void UpdateMonitorDataSnapshot();                //更新监控数据快照
