...
namespace OpenHardwareMonitorApi
{
    struct ErrorStats
    {
        ...
        int32_t invalid_sensor_value_count{};
    };
    ...
    static_assert(sizeof(ErrorStats) == 8, "ErrorStats size must be stable for ABI compatibility.");
    ...
    OPENHARDWAREMONITOR_API ErrorStats GetErrorStats();
    OPENHARDWAREMONITOR_API void ResetErrorStats();
}
